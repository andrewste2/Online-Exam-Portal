/*
    ...
    header.php is a subsection of demo.php and creates the side menu for the admin portal.
*/
    ...
    <nav class = "navbar navbar-expand-sm navbar-default">
        ...
        <div id = "main-menu" class = "main-menu collapse navbar-collapse">
            <ul class = "nav navbar-nav">
                ...
                <li>
                    <a href = "certificate.php"> <i class = "menu-icon fa fa-certificate"></i>All Certificate</a>
                </li>

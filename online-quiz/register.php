/*
    ...
    register.php allows students to register for an account. The account is stored in a mysqli
    database and their teacher can add tests to their account.
*/

// connect registration to mysqli database
<?php
...
// check if the usernmae has already been registered
<?php
